...
namespace Gadgeteer.Modules.Gadgeteerin
{
    ...
    /// </summary>
    public class IM_ServoTidy : GTM.Module
    {
        ...
        public IM_ServoTidy(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the IM_ServoTidy is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="IM_ServoTidy"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="IM_ServoTidy"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="IM_ServoTidy"/></param>
        public delegate void ButtonEventHandler(IM_ServoTidy sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="IM_ServoTidy"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="IM_ServoTidy"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="IM_ServoTidy"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(IM_ServoTidy sender, ButtonState buttonState)
        {
